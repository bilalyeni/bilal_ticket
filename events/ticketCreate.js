...
if(!interaction.isButton() && !interaction.isSelectMenu()) return;
      ...
      if(interaction.customId == `create_ticket${s}`) {
          const tcname = db.fetch(`ticketname_${interaction.guild.id}`)
                       .replace(/{user}/g, interaction.user.username).toString()
